...
public class DriveCentricTeleOp extends LinearOpMode {
    ...
    protected static ImuService imuService;
...
//        armMotorRight.setDirection(DcMotor.Direction.REVERSE);
    ...
    protected void status() {
        ...
        telemetry.addData("Region", imuService.getRegion());
        telemetry.addData("CurrentDegree", imuService.getCurrentAngle());
        telemetry.addData("StartingDegree", imuService.getStartingAngle());
        telemetry.update();
...
//    }
    ...
    public void accurateMove(Region region) {
        ...
        rx - rotation
         */
        double frontLeftPower = region.calculateFrontLeft(x,y,rx);
        double frontRightPower = region.calculateFrontRight(x,y,rx);
        double backLeftPower = region.calculateBottomLeft(x,y,rx);
        double backRightPower = region.calculateBottomRight(x,y,rx);
